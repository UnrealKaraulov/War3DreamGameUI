...
UISimpleFrame* UIObject::GetGameSimpleConsole() {
	...
	war3::CSimpleFrame* console = gameUI ? reinterpret_cast<war3::CSimpleFrame*>(gameUI->simpleConsole) : NULL;
	if (console) {
...
UISimpleFrame* UIObject::GetMinimapFrame() {
	...
	war3::CSimpleFrame* frame = gameUI ? reinterpret_cast<war3::CSimpleFrame*>(gameUI->minimapScreenFrame) : NULL;
	if (frame) {
