...
EditBoxButton::~EditBoxButton() = default;
...
void EditBoxButton::EnterText(const std::wstring & text)
{
...
void EditBoxButton::EnterTextToCurrentEditBox(const std::wstring& text)
{
	for (std::set<EditBoxButton*>::iterator iter = EditBoxButtonSet.begin();
		iter != EditBoxButtonSet.end(); ++iter)
	{
