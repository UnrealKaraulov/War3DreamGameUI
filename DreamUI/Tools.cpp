...
void* GameGlobalUI;
void* GameProfileInt;
void* GameProfileFloat;
void* GameUnitArrayGet;
war3::CGameWar3** GameGlobalObject;
void* GameStateGet;
void* GameObjectFromHash;
void* GameHandleFromObject;
void* GameTimeGet;
void* GameUnitGetObject;
void* GameItemGetObject;
void* GameAbilityFromUnit;
void* GameUIToggle;
void* GameUnitSelectionPrioGet;
void* GameSoundPlay;
void* DefaultUnitTagGet;
war3::MapInfo* GameMapInfo;
war3::CGxDevice** CGxDevice;
void* GlobalGlueMgr;
void* InputObserverGetCall;
void* PlayerNameGetCall;
void* ObjectNameGetCall;
void* GetIcon;
void* GetIconObj;
// void *AbilitySpellCheck;
void* AgentTimerVTable;
void* PlayerTechtreeGet;
void** AgileData;
void** CCommandButtonVtable;
void* AbilityDefDataGetByAID;
void* AbilityUIDefGetByAID;
void* SelectionSubgroupSetFunc;
void* SelectionSyncFunc;
void* NativeFuncGet;
void* NativeFuncCreate;
void* JassStringRvToRCString;
void* UnitDataHashTable;
void* UnitDataNodeGet;
void* ItemDataHashTable;
void* ItemDataNodeGet;
...
unsigned long VersionGet(LPCSTR fileName, unsigned int section) {
	...
	if (infoSize) {
		...
		if (buffer && GetFileVersionInfoA(fileName, NULL, infoSize, buffer)) {
...
war3::CUnit* CUnitFromHash(war3::HashGroup* hash) {
	...
	return (agent && AgentTypeIdGet(agent) == '+w3u') ? reinterpret_cast<war3::CUnit*>(agent) : NULL;
}

war3::CItem* CItemFromHash(war3::HashGroup* hash) {
	if (!hash) return NULL;
	war3::CAgent* agent = (war3::CAgent*)AgentFromHash(hash);
	return (agent && AgentTypeIdGet(agent) == 'item') ? reinterpret_cast<war3::CItem*>(agent) : NULL;
}
